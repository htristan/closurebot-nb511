# Closure Reporting Bot - NB511
This bot is designed to look at the NB511 public available API on a regular basis and do the following:
...
4. Post another update when it notices the closure is removed by NB511.
